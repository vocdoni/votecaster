      ...
      {isConnected ? (
        enoughBalance ? (
          ...
          <>
            ...
            <Text fontSize={'xs'} color={'gray'}>You can get some $DEGEN with the <Link fontStyle={'italic'} isExternal href='https://bridge.degen.tips/'>Degen Chain Bridge</Link> 🎩</Text>
          </>
        )
      ) : (
