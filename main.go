...
func main() {
	...
	if censusInfo.FarcasterParticipantCount == 0 {
		censusInfo.FarcasterParticipantCount = uint32(censusInfo.Size)
	}
	...
	if err := uAPI.Endpoint.RegisterMethod("/rankings/communitiesByYieldRate", http.MethodGet, "public", handler.rankingByYieldRate); err != nil {
		log.Fatal(err)
	}
